...
enableRefinerMonitoring = true --export: enable or diable the Refiners monitoring
enableAssemblyMonitoring = true --export: enable or diable the Assembly lines monitoring
enableSmelterMonitoring = true --export: enable or diable the Smelters monitoring
enableChemicalMonitoring = true --export: enable or diable the Chemical industries monitoring
enableElectronicsMonitoring = true --export: enable or diable the Electronics Industries monitoring
enableGlassMonitoring = true --export: enable or diable the Glass Furnace monitoring
enableHoneycombMonitoring = true --export: enable or diable the Honeycomb Refineries monitoring
enableRecyclerMonitoring = true --export: enable or diable the Recyclers monitoring
enableMetalworkMonitoring = true --export: enable or diable the Metalworks monitoring
enable3DPrinterMonitoring = true --export: enable or diable the 3D Printers monitoring
