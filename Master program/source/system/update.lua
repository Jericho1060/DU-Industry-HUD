...
if hud_displayed == true then
    ...
    if #elements > 0 then
        ...
        if #markers == 0 then
            table.insert(markers, core.spawnArrowSticker(x, y, z+2.5, "down"))
            table.insert(markers, core.spawnArrowSticker(x, y, z+2.5, "down"))
            core.rotateSticker(markers[2],0,0,90)
            table.insert(markers, core.spawnArrowSticker(x+1, y, z+1.5, "north"))
            table.insert(markers, core.spawnArrowSticker(x+1, y, z+1.5, "north"))
            core.rotateSticker(markers[4],90,90,0)
            table.insert(markers, core.spawnArrowSticker(x-1, y, z+1.5, "south"))
            table.insert(markers, core.spawnArrowSticker(x-1, y, z+1.5, "south"))
            core.rotateSticker(markers[6],90,-90,0)
            table.insert(markers, core.spawnArrowSticker(x, y-2, z+1.5, "east"))
            table.insert(markers, core.spawnArrowSticker(x, y-2, z+1.5, "east"))
            core.rotateSticker(markers[8],90,0,90)
            table.insert(markers, core.spawnArrowSticker(x, y+2, z+1.5, "west"))
            table.insert(markers, core.spawnArrowSticker(x, y+2, z+1.5, "west"))
            core.rotateSticker(markers[10],-90,0,90)
        else
            core.moveSticker(markers[1], x, y, z+2.5)
            core.moveSticker(markers[2], x, y, z+2.5)
            core.moveSticker(markers[3], x+1, y, z+1.5)
            core.moveSticker(markers[4], x+1, y, z+1.5)
            core.moveSticker(markers[5], x-1, y, z+1.5)
            core.moveSticker(markers[6], x-1, y, z+1.5)
            core.moveSticker(markers[7], x, y-2, z+1.5)
            core.moveSticker(markers[8], x, y-2, z+1.5)
            core.moveSticker(markers[9], x, y+2, z+1.5)
            core.moveSticker(markers[10], x, y+2, z+1.5)
        end
        local status = "-"
